...
from main.videocaptureasync import VideoCaptureAsync
from main.arguments import opt
from main.utils import info, Once, Tee, crop, pad_img, resize, TicToc
import main.camera_selector as cam_selector
...
if __name__ == "__main__":
    ...
    if opt.is_worker:
        from main import predictor_worker
        predictor_worker.run_worker(opt.in_port, opt.out_port)
        sys.exit(0)
    elif opt.is_client:
        from main import predictor_remote
        try:
        ...
        from main import predictor_local
